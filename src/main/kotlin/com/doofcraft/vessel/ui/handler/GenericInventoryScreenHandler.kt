package com.doofcraft.vessel.ui.handler
...
class GenericInventoryScreenHandler(syncId: Int, private val playerInventory: Inventory, inventory: Container) : ChestMenu(
    ...
    override fun clicked(slotId: Int, button: Int, clickType: ClickType, player: Player) {
        // Only allow interaction outside of the inventory slots
        if (slotId >= 0 && slotId < container.containerSize) {
            ...
            if (clickType == ClickType.PICKUP) {
                ...
                val context = UiManager.service.getContext(player as ServerPlayer) ?: return
                InventoryButton.click(player, buttonData, context)
            }
        }
